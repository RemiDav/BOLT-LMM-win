...
int main(int argc, char *argv[]) {
  ...
  cout << "                      +-----------------------------+" << endl;
  cout << "                      |                       ___   |" << endl;
  cout << "                      |   BOLT-LMM, v2.3.2   /_ /   |" << endl;
  cout << "                      |   March 10, 2018      /_/   |" << endl;
  cout << "                      |   Po-Ru Loh            //   |" << endl;
  cout << "                      |                        /    |" << endl;
  cout << "                      +-----------------------------+" << endl;
  cout << endl;
  cout << "Copyright (C) 2014-2018 Harvard University." << endl;
  ...
  DataMatrix covarDataT(params.covarFile, snpData);
  ...
  if (!params.phenoFile.empty()) { // phenotypes provided in file
    ...
    DataMatrix phenoDataT(params.phenoFile, snpData);
  ...
  if (params.lmmInf) {
    ...
    if (!params.predBetasFile.empty()) {
      cout << endl << "=== Computing and writing betas for risk prediction ===" << endl << endl;
